...
public class StubServerConfig {
    ...
    public static final ExceptionResponse ES_BAD_REQUEST = new ExceptionResponse(String.valueOf(400), "Bad request");
    public static final ExceptionResponse ES_SERVER_ERROR = new ExceptionResponse(String.valueOf(500), "Could not connect to Encryption Service");
    public static final ExceptionResponse DS_NOT_FOUND_REQUEST = new ExceptionResponse("DS404", "Resource not found");
    public static final ExceptionResponse DS_SERVER_ERROR = new ExceptionResponse("DS500", "Could not connect to download Service");
